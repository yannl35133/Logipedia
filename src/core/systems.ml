type t = Coq | Matita | Pvs | OpenTheory | Lean | Hollight | Latex | IsabelleHOL

let systems = [Coq ; Matita ; Pvs ; OpenTheory ; Lean ; Hollight ; Latex; IsabelleHOL]
